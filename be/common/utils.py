    ...
    chain_list = [
        {
            ...
            "chain_id": 43114,
            "rpc_url": os.getenv("NODE_RPC_URL_AVAX", "https://api.avax.network/ext/bc/C/rpc"),
        },
        {
            "chain_name": "avax_fuji",
            "chain_id": 43113,
            "rpc_url": os.getenv("NODE_RPC_URL_AVAX_FUJI", "https://api.avax-test.network/ext/bc/C/rpc"),
        },
    ]
