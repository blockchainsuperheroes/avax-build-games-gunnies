...
import { EXTERNAL_LINK } from '../constants/external_link';
    ...
    <section className="min-h-[calc(100dvh-300px)]">
      <div className="flex flex-col items-center justify-center pt-10">
        ...
        <h1 className="text-[28px] md:text-[58px] leading-[32px] md:leading-[64px] font-bold font-chakra uppercase text-center z-10 text-[#1CBBBB] w-2/3 mx-auto">
          DOWNLOAD LAUNCHER & READ THE GAME GUIDE
        </h1>

        <div className="flex flex-col items-center justify-center gap-5 md:gap-8 mt-12 md:mt-16 z-10">
          {/* Download from EPIC */}
          <div className="border-[3px] border-[#F77E1E] rounded-3xl bg-[#00000080] p-4">
            <div className="bg-[#1CBBBB] rounded-2xl flex flex-col md:flex-row items-center justify-center md:justify-between gap-2 md:gap-6 px-8 py-4 md:px-[28px] md:py-[37px] w-[309px] md:w-[814px]">
              <div className="flex flex-col md:flex-row items-center justify-center gap-2 md:gap-3">
                <Image width={40} height={40} src="/images/epic.png" alt="Epic Games" className=" w-16 md:w-10 h-16 md:h-10 object-contain" />
                <p className="text-xl md:text-[28px] font-semibold font-sora text-black">
                  Download from EPIC
                </p>
              </div>
              ...
              <button
                ...
                onClick={() => window.open(EXTERNAL_LINK.EPIC, '_blank')}
              >
          ...
          <div className="border-[3px] border-[#F77E1E] rounded-3xl bg-[#00000080] p-4">
            <div className="bg-[#1CBBBB] rounded-2xl flex flex-col md:flex-row items-center justify-center md:justify-between gap-2 md:gap-6 px-8 py-4 md:px-[28px] md:py-[37px] w-[309px] md:w-[814px]">
              <div className="flex flex-col md:flex-row items-center justify-center gap-2 md:gap-3">
                <Image width={40} height={40} src="/images/download/pen-logo.png" alt="Launcher" className=" w-16 md:w-10 h-16 md:h-10 object-contain" />
                <p className="text-xl md:text-[28px] font-semibold font-sora text-black">
                  Download Launcher
                </p>
              </div>
          ...
          <div className="border-[3px] border-[#F77E1E] rounded-3xl bg-[#00000080] p-4">
            <div className="bg-[#1CBBBB] rounded-2xl flex flex-col md:flex-row items-center justify-center md:justify-between gap-2 md:gap-6 px-8 py-4 md:px-[28px] md:py-[37px] w-[309px] md:w-[814px]">
              <div className="flex flex-col md:flex-row items-center justify-center gap-2 md:gap-3">
                <Image width={40} height={40} src="/images/download/game-guide.png" alt="Game Guide" />
                <p className="text-xl md:text-[28px] font-semibold font-sora text-black">
                  Game Guide.pdf
                </p>
              </div>
